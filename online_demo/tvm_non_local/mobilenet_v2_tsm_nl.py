...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1.):
        ...
        from non_local import make_non_local_MV2, NL3DWrappe_MV2_shift
        self.features = make_non_local_MV2(self.features, 1)
    ...
    def forward(self, x, *shift_buffer):
        ...
        for f in self.features:
            ...
            if isinstance(f, InvertedResidualWithShift):
                ...
                # print(shift_buffer_idx)
                shift_buffer_idx += 1
                out_buffer.append(s)

            elif isinstance(f, NL3DWrappe_MV2_shift):
                x, s = f(x, shift_buffer[shift_buffer_idx])
                shift_buffer_idx += 1
                out_buffer.append(s)
